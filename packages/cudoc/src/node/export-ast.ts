...
export type ExportAstOptions = PathOptions & {
  ...
  validate?: boolean
  /** Cell element names to validate when layout rules use custom components. */
...
export const resolveExportAstOptions = (
  ...
  tableCellElement: options.tableCellElement,
...
export const buildExportedAst = (
  ...
  if (context.validate) {
    validateAstContract(exportTree, {
      ...
      tableCellElement: context.tableCellElement,
    })
  }
