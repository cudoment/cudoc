...
| [어댑터](./adapters.ko.md)   | remark, 캡처, 호스트 순서, VitePress 토큰, HTML 생성    |
...
- `cudoc-vitepress`는 실제 Markdown-it 파이프라인을 연결합니다.
...
| `/styles.css`                                                      | 알림과 배지 스타일                     | [스타일 소스](../../packages/cudoc/styles.css)     |
...
| `cudoc-vitepress`                                                  | Markdown-it 어댑터와 컴파일러          | [VitePress](./adapters.ko.md#vitepress)            |
